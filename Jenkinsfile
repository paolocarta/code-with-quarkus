        ...
        stage('Image Build and Push') {
            ...
            steps {
                container('kaniko') {
                    ...
                    sh "/kaniko/executor --dockerfile $HOME/agent/workspace/bernetes-example-pipeline_master/src/main/docker/Dockerfile.jvm --context=dir://$HOME/agent/workspace/bernetes-example-pipeline_master \
